...
export const routes: Routes = [
  ...
  { path: 'set-password', component: ForceChangePasswordComponent, canActivate: [AuthGuard] },
...

  {
    ...
    children: [
      ...
      { path: 'manage-admins', component: ManageSuperAdminAdminsComponent, canActivate: [SuperAdminAuthGuard] },
      { path: 'add-admin', component: AddAdminComponent, canDeactivate: [CanDeactivateGuard], canActivate: [SuperAdminAuthGuard] },
      { path: 'edit-admin/:id', component: AddAdminComponent, canActivate: [SuperAdminAuthGuard] },
      { path: 'view-admin/:id', component: AddAdminComponent, canActivate: [SuperAdminAuthGuard] },

      { path: 'manage-permissions', component: ManagePermissionsComponent, canActivate: [SuperAdminAuthGuard] },
      { path: 'add-permission', component: AddPermissionsComponent, canDeactivate: [CanDeactivateGuard], canActivate: [SuperAdminAuthGuard] },
      { path: 'add-permission/:id', component: AddPermissionsComponent, canDeactivate: [CanDeactivateGuard], canActivate: [SuperAdminAuthGuard] },

      { path: 'manage-admin-permissions', component: ManageAdminPermissionsComponent, canActivate: [SuperAdminAuthGuard] },

      {
        path: 'super-reports',
        loadComponent: () => import('./super-admin/reports-dashboard/reports-dashboard.component')
          .then(m => m.ReportsDashboardComponent),
        canActivate: [SuperAdminAuthGuard]
      },

      { path: 'manage-plans', component: ManagePlansComponent, canActivate: [SuperAdminAuthGuard] },
      { path: 'add-plans', component: AddPlansComponent, canActivate: [SuperAdminAuthGuard] },
      { path: 'add-plans/:id', component: AddPlansComponent, canActivate: [SuperAdminAuthGuard] },

      { path: 'manage-features', component: ManageFeaturesComponent, canActivate: [SuperAdminAuthGuard] },
      { path: 'add-features', component: AddFeaturesComponent, canActivate: [SuperAdminAuthGuard] },
      { path: 'add-features/:id', component: AddFeaturesComponent, canActivate: [SuperAdminAuthGuard] },

      { path: 'manage-smtp-config', component: ManageSmtpConfigComponent, canActivate: [SuperAdminAuthGuard] },
      { path: 'add-smtp-config', component: AddSmtpConfigComponent, canActivate: [SuperAdminAuthGuard] },
      { path: 'add-smtp-config/:id', component: AddSmtpConfigComponent, canActivate: [SuperAdminAuthGuard] },

      // ---- Theme Configuration (Super Admin) ----
      { path: 'manage-themes', component: ManageThemesComponent, canActivate: [SuperAdminAuthGuard] },
      { path: 'add-theme', component: AddThemeComponent, canActivate: [SuperAdminAuthGuard] },
      { path: 'add-theme/:id', component: AddThemeComponent, canActivate: [SuperAdminAuthGuard] },
      { path: 'change-user-theme/:adminId', component: ChangeUserThemeComponent, canActivate: [SuperAdminAuthGuard] },
      ...
      // =====================================================================
      { path: 'user-dashboard', component: AdminDashboardComponent, canActivate: [AdminAuthGuard, paymentStatusGuard] },
      { path: 'forgot-password', component: ForgotPasswordComponent, canActivate: [AdminAuthGuard] },

      // FIX: exact single permission — this is conceptually part of role management
      { path: 'manage-default-permissions', component: ManageDefaultPermissionsComponent,
      ...
      { path: 'manage-customer/:projectId', component: ManageCustomerComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'manage_customer' } },
...

      {
        ...
        loadComponent: () => import('./customer/customer-user/import-customer/import-customer.component')
          .then(m => m.ImportCustomerComponent),
        canActivate: [AdminAuthGuard, paymentStatusGuard]
      },

      { path: 'plan-payment-history', component: PlanPaymentHistoryComponent, canActivate: [AdminAuthGuard, paymentStatusGuard] },
      { path: 'payment-details/:id', component: PlanPaymentComponent, canActivate: [AdminAuthGuard, paymentStatusGuard] },
      ...
      { path: 'add-users', component: AddSubAdminComponent, canDeactivate: [CanDeactivateGuard],
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'add_sub_admin_users' } },

      { path: 'edit-users/:id', component: AddSubAdminComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'edit_sub_admin_users' } },

      { path: 'view-users/:id', component: AddSubAdminComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'view_sub_admin_users' } },

      { path: 'password-reset-requests', component: PasswordResetRequestsComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
      ...
      { path: 'add-roles', component: AddRolesComponent, canDeactivate: [CanDeactivateGuard],
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'add_role' } },


      { path: 'add-roles/:id', component: AddRolesComponent, canDeactivate: [CanDeactivateGuard],
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'view_role' } },

      { path: 'manage-user-permissions', component: ManageSubadminPermissionsComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
      ...
      { path: 'project-detail/:id', component: AddProjectsComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'view_project' } },
      ...
      { path: 'category-detail/:id', component: AddCategoryComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'view_category' } },
      ...
      { path: 'sub-category-detail/:id', component: AddSubCategoryComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'view_subcategory' } },
      ...
      { path: 'user-sessions', component: UsersHistoryComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'manage_user_history', allowSuperAdmin: true } },
      { path: 'login-details/:sessionId', component: LoginDetailsComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'manage_user_history', allowSuperAdmin: true } },
      { path: 'activity-details', component: ActivityDetailsComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'manage_activity_details', allowSuperAdmin: true } },
      { path: 'activity-details/:sessionId', component: ActivityDetailsComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'manage_activity_details', allowSuperAdmin: true } },
      { path: 'activity-line/:id', component: ActivityLineComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'manage_activity_details', allowSuperAdmin: true } },

      // ---- Communication ----
      { path: 'manage-event-trigger', component: ManageEventTriggerComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'view_event', allowSuperAdmin: true  } },
      { path: 'add-event-trigger', component: AddEventTriggerComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'add_event', allowSuperAdmin: true  } },
      { path: 'event-trigger-detail/:id', component: AddEventTriggerComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'view_event', allowSuperAdmin: true  } },

      { path: 'manage-email-templates', component: ManageEmailTemplateComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
      ...
      { path: 'email-template-detail/:id', component: AddEmailTemplateComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'view_email_template', allowSuperAdmin: true  } },

      { path: 'manage-sms-templates', component: ManageSmsTemplateComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
      ...
      { path: 'sms-template-detail/:id', component: AddSmsTemplateComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'view_sms', allowSuperAdmin: true  } },

      { path: 'manage-whatsapp-templates', component: ManageWhatsappTemplateComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'view_whatsapp_template' , allowSuperAdmin: true } },
      { path: 'add-whatsapp-template', component: AddWhatsappTemplateComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'add_whatsapp_template' , allowSuperAdmin: true } },
      { path: 'whatsapp-template-detail/:id', component: AddWhatsappTemplateComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'view_whatsapp_template' , allowSuperAdmin: true } },

      // ---- Theme Configuration (Admin self-service) ----
      { path: 'choose-theme', component: ChangeUserThemeComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
        data: { permission: 'manage_choose_theme' } },
      { path: 'customize-theme', component: ChangeUserThemeComponent,
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
      ...
      {
        path: 'reports',
        loadComponent: () => import('./admin/reports-analysis/reports-analysis.component')
          .then(m => m.ReportsAnalysisComponent),
        canActivate: [AdminAuthGuard, paymentStatusGuard, SubAdminPermissionGuard],
